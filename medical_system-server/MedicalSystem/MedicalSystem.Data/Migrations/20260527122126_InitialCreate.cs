        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastWriteOffDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastReceiptFrom = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    LastOperation = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Implants = table.Column<string>(type: "text", nullable: true),
